...
aq_berlin_wed_amr <- left_join(cleaned_b_met, pivoted_wed_amr, by = "date"); 
aq_berlin_sch_bel <- left_join(cleaned_b_met, pivoted_sch_bel, by = "date");
aq_berlin_neu_sil <- left_join(cleaned_b_met, pivoted_neu_sil, by = "date");
aq_berlin_fri_fra <- left_join(cleaned_b_met, pivoted_fri_fra, by = "date");
...
aq_leipzig_west <- left_join(cleaned_l_met, pivoted_l_west, by = "date");
aq_leipzig_mitte <- left_join(cleaned_l_met, pivoted_l_mitte, by = "date");
...
aq_hamburg_str <- left_join(cleaned_ham_met, pivoted_ham_str, by = "date");
...
aq_rural_col <- left_join(cleaned_hol_met, pivoted_rur_col, by = "date");
